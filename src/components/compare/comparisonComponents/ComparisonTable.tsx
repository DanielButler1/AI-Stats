					...
					<TableBody>
									...
									>
										...
										<div className="flex items-center justify-center gap-1">
											...
											{outputPrice !== null
												...
												: "-"}
											{outputPrice === bestOutputPrice &&
												bestOutputPrice !== null && (
													<Star className="h-4 w-4 text-pink-400 fill-pink-400" />
												)}
										</div>
									</TableCell>
						...
						{allBenchmarks.map((benchmarkName) => {
							...
							const rawScores = selectedModels.map((model) => {
								const score = model.benchmark_results?.find(
