...
var request = new ChatCompletionsRequest(
    ...
    messages: new List<ChatMessage> {
        new ChatMessage(new ChatMessageUser(ChatMessageUser.RoleEnum.User, new MessageContentText(MessageContentText.TypeEnum.Text, "Write a limerick about lighthouses.")))
    }
);

var response = client.GenerateText(request);
```
