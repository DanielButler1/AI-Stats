...
Your name will also appear in the [Contributors page](https://ai-stats.phaseo.app/contribute), recognising your contributions.
...
<Columns cols={2}>
	...
	<Card
		title="Non-Code Edits"
		icon="file-text"
		href="/v1/contributing/non-code-edits"
	>
...
1. **Fork** the [AI Stats GitHub repository](https://github.com/DanielButler1/AI-Stats).
...
# 3. Make your edits
# e.g. edit src/data/models/new-openai-model.json
...
-   Ask in the [AI Stats Discord](https://discord.gg/phaseo).
...
<Columns cols={2}>
	...
	>
		Learn how the AI Stats repository is organised.
	</Card>
</Columns>
