...
#include "ai_stats_sdk_cpp/model/AIStatsToolCall_function.h"
...
AIStatsToolCall_function::AIStatsToolCall_function()
{
...
void AIStatsToolCall_function::validate()
{
    // TODO: implement validation
}

web::json::value AIStatsToolCall_function::toJson() const
{
...
bool AIStatsToolCall_function::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void AIStatsToolCall_function::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool AIStatsToolCall_function::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t AIStatsToolCall_function::getName() const
{
    return m_Name;
}


void AIStatsToolCall_function::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool AIStatsToolCall_function::nameIsSet() const
{
    return m_NameIsSet;
}

void AIStatsToolCall_function::unsetName()
{
    m_NameIsSet = false;
}
utility::string_t AIStatsToolCall_function::getArguments() const
{
    return m_Arguments;
}


void AIStatsToolCall_function::setArguments(const utility::string_t& value)
{
    m_Arguments = value;
    m_ArgumentsIsSet = true;
}

bool AIStatsToolCall_function::argumentsIsSet() const
{
    return m_ArgumentsIsSet;
}

void AIStatsToolCall_function::unsetArguments()
{
    m_ArgumentsIsSet = false;
}
utility::string_t AIStatsToolCall_function::getDescription() const
{
    return m_Description;
}


void AIStatsToolCall_function::setDescription(const utility::string_t& value)
{
    m_Description = value;
    m_DescriptionIsSet = true;
}

bool AIStatsToolCall_function::descriptionIsSet() const
{
    return m_DescriptionIsSet;
}

void AIStatsToolCall_function::unsetDescription()
{
    m_DescriptionIsSet = false;
}
std::shared_ptr<Object> AIStatsToolCall_function::getParameters() const
{
    return m_Parameters;
}


void AIStatsToolCall_function::setParameters(const std::shared_ptr<Object>& value)
{
    m_Parameters = value;
    m_ParametersIsSet = true;
}

bool AIStatsToolCall_function::parametersIsSet() const
{
    return m_ParametersIsSet;
}

void AIStatsToolCall_function::unsetParameters()
{
    m_ParametersIsSet = false;
}
