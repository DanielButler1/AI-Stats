...
#include "ai_stats_sdk_cpp/model/AIStatsTextContentPart.h"
...
AIStatsTextContentPart::AIStatsTextContentPart()
{
    m_TypeIsSet = false;
...
void AIStatsTextContentPart::validate()
{
    // TODO: implement validation
}

web::json::value AIStatsTextContentPart::toJson() const
{
...
bool AIStatsTextContentPart::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void AIStatsTextContentPart::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool AIStatsTextContentPart::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
AIStatsTextContentPart::TypeEnum AIStatsTextContentPart::toTypeEnum(const utility::string_t& value) const
{
...
const utility::string_t AIStatsTextContentPart::fromTypeEnum(const TypeEnum value) const
{
    switch(value)
    {
...
AIStatsTextContentPart::TypeEnum AIStatsTextContentPart::getType() const
{
    return m_Type;
}


void AIStatsTextContentPart::setType(const TypeEnum value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool AIStatsTextContentPart::typeIsSet() const
{
    return m_TypeIsSet;
}

void AIStatsTextContentPart::unsetType()
{
    m_TypeIsSet = false;
}
utility::string_t AIStatsTextContentPart::getText() const
{
    return m_Text;
}


void AIStatsTextContentPart::setText(const utility::string_t& value)
{
    m_Text = value;
    m_TextIsSet = true;
}

bool AIStatsTextContentPart::textIsSet() const
{
    return m_TextIsSet;
}

void AIStatsTextContentPart::unsetText()
{
    m_TextIsSet = false;
}
