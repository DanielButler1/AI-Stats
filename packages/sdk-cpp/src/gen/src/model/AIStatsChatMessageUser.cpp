...
#include "ai_stats_sdk_cpp/model/AIStatsChatMessageUser.h"
...
AIStatsChatMessageUser::AIStatsChatMessageUser()
{
    m_RoleIsSet = false;
...
void AIStatsChatMessageUser::validate()
{
    // TODO: implement validation
}

web::json::value AIStatsChatMessageUser::toJson() const
{
...
bool AIStatsChatMessageUser::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void AIStatsChatMessageUser::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool AIStatsChatMessageUser::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
AIStatsChatMessageUser::RoleEnum AIStatsChatMessageUser::toRoleEnum(const utility::string_t& value) const
{
...
const utility::string_t AIStatsChatMessageUser::fromRoleEnum(const RoleEnum value) const
{
    switch(value)
    {
...
AIStatsChatMessageUser::RoleEnum AIStatsChatMessageUser::getRole() const
{
    return m_Role;
}


void AIStatsChatMessageUser::setRole(const RoleEnum value)
{
    m_Role = value;
    m_RoleIsSet = true;
}

bool AIStatsChatMessageUser::roleIsSet() const
{
    return m_RoleIsSet;
}

void AIStatsChatMessageUser::unsetRole()
{
    m_RoleIsSet = false;
}
std::shared_ptr<AIStatsMessageContent> AIStatsChatMessageUser::getContent() const
{
    return m_Content;
}


void AIStatsChatMessageUser::setContent(const std::shared_ptr<AIStatsMessageContent>& value)
{
    m_Content = value;
    m_ContentIsSet = true;
}

bool AIStatsChatMessageUser::contentIsSet() const
{
    return m_ContentIsSet;
}

void AIStatsChatMessageUser::unsetContent()
{
    m_ContentIsSet = false;
}
utility::string_t AIStatsChatMessageUser::getName() const
{
    return m_Name;
}


void AIStatsChatMessageUser::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool AIStatsChatMessageUser::nameIsSet() const
{
    return m_NameIsSet;
}

void AIStatsChatMessageUser::unsetName()
{
    m_NameIsSet = false;
}
