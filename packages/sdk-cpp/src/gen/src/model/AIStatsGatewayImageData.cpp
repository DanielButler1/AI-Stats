...
#include "ai_stats_sdk_cpp/model/AIStatsGatewayImageData.h"
...
AIStatsGatewayImageData::AIStatsGatewayImageData()
{
...
void AIStatsGatewayImageData::validate()
{
    // TODO: implement validation
}

web::json::value AIStatsGatewayImageData::toJson() const
{
...
bool AIStatsGatewayImageData::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void AIStatsGatewayImageData::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool AIStatsGatewayImageData::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t AIStatsGatewayImageData::getUrl() const
{
    return m_Url;
}


void AIStatsGatewayImageData::setUrl(const utility::string_t& value)
{
    m_Url = value;
    m_UrlIsSet = true;
}

bool AIStatsGatewayImageData::urlIsSet() const
{
    return m_UrlIsSet;
}

void AIStatsGatewayImageData::unsetUrl()
{
    m_UrlIsSet = false;
}
