...
#include "ai_stats_sdk_cpp/model/AIStatsImagesEditResponse.h"
...
AIStatsImagesEditResponse::AIStatsImagesEditResponse()
{
    m_Created = 0;
...
void AIStatsImagesEditResponse::validate()
{
    // TODO: implement validation
}

web::json::value AIStatsImagesEditResponse::toJson() const
{
...
bool AIStatsImagesEditResponse::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void AIStatsImagesEditResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool AIStatsImagesEditResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
int32_t AIStatsImagesEditResponse::getCreated() const
{
    return m_Created;
}

void AIStatsImagesEditResponse::setCreated(int32_t value)
{
    m_Created = value;
    m_CreatedIsSet = true;
}

bool AIStatsImagesEditResponse::createdIsSet() const
{
    return m_CreatedIsSet;
}

void AIStatsImagesEditResponse::unsetCreated()
{
    m_CreatedIsSet = false;
}
std::vector<std::shared_ptr<AIStatsImage>> AIStatsImagesEditResponse::getData() const
{
    return m_Data;
}


void AIStatsImagesEditResponse::setData(const std::vector<std::shared_ptr<AIStatsImage>>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool AIStatsImagesEditResponse::dataIsSet() const
{
    return m_DataIsSet;
}

void AIStatsImagesEditResponse::unsetData()
{
    m_DataIsSet = false;
}
