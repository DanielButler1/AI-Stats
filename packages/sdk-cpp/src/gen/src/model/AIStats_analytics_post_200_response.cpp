...
#include "ai_stats_sdk_cpp/model/AIStats_analytics_post_200_response.h"
...
AIStats_analytics_post_200_response::AIStats_analytics_post_200_response()
{
    m_Ok = false;
    m_OkIsSet = false;
...
void AIStats_analytics_post_200_response::validate()
{
    // TODO: implement validation
}

web::json::value AIStats_analytics_post_200_response::toJson() const
{
...
bool AIStats_analytics_post_200_response::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void AIStats_analytics_post_200_response::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool AIStats_analytics_post_200_response::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
bool AIStats_analytics_post_200_response::isOk() const
{
    return m_Ok;
}

void AIStats_analytics_post_200_response::setOk(bool value)
{
    m_Ok = value;
    m_OkIsSet = true;
}

bool AIStats_analytics_post_200_response::okIsSet() const
{
    return m_OkIsSet;
}

void AIStats_analytics_post_200_response::unsetOk()
{
    m_OkIsSet = false;
}
utility::string_t AIStats_analytics_post_200_response::getStatus() const
{
    return m_Status;
}


void AIStats_analytics_post_200_response::setStatus(const utility::string_t& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool AIStats_analytics_post_200_response::statusIsSet() const
{
    return m_StatusIsSet;
}

void AIStats_analytics_post_200_response::unsetStatus()
{
    m_StatusIsSet = false;
}
utility::string_t AIStats_analytics_post_200_response::getMessage() const
{
    return m_Message;
}


void AIStats_analytics_post_200_response::setMessage(const utility::string_t& value)
{
    m_Message = value;
    m_MessageIsSet = true;
}

bool AIStats_analytics_post_200_response::messageIsSet() const
{
    return m_MessageIsSet;
}

void AIStats_analytics_post_200_response::unsetMessage()
{
    m_MessageIsSet = false;
}
