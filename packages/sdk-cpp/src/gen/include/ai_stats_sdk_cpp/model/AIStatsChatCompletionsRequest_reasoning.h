...
#include "ai_stats_sdk_cpp/model/AIStatsAIStatsReasoningConfig.h"
...
{
public:
    AIStatsChatCompletionsRequest_reasoning() = default;
    ~AIStatsChatCompletionsRequest_reasoning() = default;
    ...
    using VariantType = std::variant<AIStatsReasoningConfig, std::vector<std::shared_ptr<AIStatsReasoningConfig>>>;
