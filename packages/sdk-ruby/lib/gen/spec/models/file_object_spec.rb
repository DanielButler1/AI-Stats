...
# Unit tests for AIStatsSdk::FileObject
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe AIStatsSdk::FileObject do
  #let(:instance) { AIStatsSdk::FileObject.new }

  describe 'test an instance of FileObject' do
    it 'should create an instance of FileObject' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(AIStatsSdk::FileObject)
    end
  end
