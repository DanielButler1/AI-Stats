...
# Unit tests for AIStatsSdk::ChatMessageAssistant
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe AIStatsSdk::ChatMessageAssistant do
  #let(:instance) { AIStatsSdk::ChatMessageAssistant.new }

  describe 'test an instance of ChatMessageAssistant' do
    it 'should create an instance of ChatMessageAssistant' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(AIStatsSdk::ChatMessageAssistant)
    end
  end
