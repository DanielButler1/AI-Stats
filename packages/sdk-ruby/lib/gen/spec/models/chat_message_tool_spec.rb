...
# Unit tests for AIStatsSdk::ChatMessageTool
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe AIStatsSdk::ChatMessageTool do
  #let(:instance) { AIStatsSdk::ChatMessageTool.new }

  describe 'test an instance of ChatMessageTool' do
    it 'should create an instance of ChatMessageTool' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(AIStatsSdk::ChatMessageTool)
    end
  end
