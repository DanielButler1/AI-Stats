  ...
  class FilesApi
    ...
    def files_file_id_get_with_http_info(file_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: FilesApi.files_file_id_get ...'
      end
      # verify the required parameter 'file_id' is set
      if @api_client.config.client_side_validation && file_id.nil?
        fail ArgumentError, "Missing the required parameter 'file_id' when calling FilesApi.files_file_id_get"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"FilesApi.files_file_id_get",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: FilesApi#files_file_id_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
