...
module AIStatsSdk
  class ChatCompletionsRequest < ApiModelBase
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'max_completions_tokens')
        self.max_completions_tokens = attributes[:'max_completions_tokens']
      end
    ...
    def list_invalid_properties
      ...
      if !@max_completions_tokens.nil? && @max_completions_tokens < 1
        invalid_properties.push('invalid value for "max_completions_tokens", must be greater than or equal to 1.')
      end
    ...
    def valid?
      ...
      return false if !@max_completions_tokens.nil? && @max_completions_tokens < 1
    ...
    # Custom attribute writer method with validation
    # @param [Object] max_completions_tokens Value to be assigned
    def max_completions_tokens=(max_completions_tokens)
      if max_completions_tokens.nil?
        fail ArgumentError, 'max_completions_tokens cannot be nil'
      end

      if max_completions_tokens < 1
        fail ArgumentError, 'invalid value for "max_completions_tokens", must be greater than or equal to 1.'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          max_completions_tokens == o.max_completions_tokens &&
          meta == o.meta &&
          model == o.model &&
          messages == o.messages &&
    ...
    def hash
      [reasoning, frequency_penalty, logit_bias, max_output_tokens, max_completions_tokens, meta, model, messages, presence_penalty, seed, stream, temperature, tools, max_tool_calls, parallel_tool_calls, tool_choice, logprobs, top_logprobs, top_p, usage].hash
    end
