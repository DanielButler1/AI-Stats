...
*/
func (a *CompletionsAPIService) CreateChatCompletion(ctx context.Context) ApiCreateChatCompletionRequest {
	return ApiCreateChatCompletionRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *CompletionsAPIService) CreateChatCompletionExecute(r ApiCreateChatCompletionRequest) (*ChatCompletionsResponse, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CompletionsAPIService.CreateChatCompletion")
	if err != nil {
