...
type ApiVideoGenerationPostRequest struct {
	ctx context.Context
	ApiService *VideoAPIService
	videoGenerationRequest *VideoGenerationRequest
}

func (r ApiVideoGenerationPostRequest) VideoGenerationRequest(videoGenerationRequest VideoGenerationRequest) ApiVideoGenerationPostRequest {
	r.videoGenerationRequest = &videoGenerationRequest
	return r
}

func (r ApiVideoGenerationPostRequest) Execute() (*VideoGenerationResponse, *http.Response, error) {
	return r.ApiService.VideoGenerationPostExecute(r)
}

/*
VideoGenerationPost Generate video
...
Creates an async video generation job or direct asset depending on the upstream provider. The payload is returned verbatim with gateway metadata attached.
 ...
 @return ApiVideoGenerationPostRequest
*/
func (a *VideoAPIService) VideoGenerationPost(ctx context.Context) ApiVideoGenerationPostRequest {
	return ApiVideoGenerationPostRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *VideoAPIService) VideoGenerationPostExecute(r ApiVideoGenerationPostRequest) (*VideoGenerationResponse, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "VideoAPIService.VideoGenerationPost")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/video/generation"
