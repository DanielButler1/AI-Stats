...
*/
func (a *ResponsesAPIService) CreateResponse(ctx context.Context) ApiCreateResponseRequest {
	return ApiCreateResponseRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *ResponsesAPIService) CreateResponseExecute(r ApiCreateResponseRequest) (*ResponsesResponse, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ResponsesAPIService.CreateResponse")
	if err != nil {
