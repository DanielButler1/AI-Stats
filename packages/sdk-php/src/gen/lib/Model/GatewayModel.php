...
/**
 * GatewayModel Class Doc Comment
 *
 * @category Class
 * @package  AIStats\\Sdk
 * @author   OpenAPI Generator team
 ...
 */
class GatewayModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GatewayModel';
    ...
    public const ENDPOINTS_CHAT_COMPLETIONS = 'chat.completions';
    public const ENDPOINTS_IMAGES_GENERATIONS = 'images.generations';
    public const ENDPOINTS_AUDIO_SPEECH = 'audio.speech';
    public const ENDPOINTS_AUDIO_TRANSCRIPTION = 'audio.transcription';
    public const ENDPOINTS_MODERATIONS = 'moderations';
    public const ENDPOINTS_VIDEO_GENERATION = 'video.generation';
    public const ENDPOINTS_EMBEDDINGS = 'embeddings';
    public const ENDPOINTS_BATCH = 'batch';
     ...
     * @return string[]
     */
    public function getEndpointsAllowableValues()
    {
        return [
            self::ENDPOINTS_CHAT_COMPLETIONS,
            self::ENDPOINTS_IMAGES_GENERATIONS,
            self::ENDPOINTS_AUDIO_SPEECH,
            self::ENDPOINTS_AUDIO_TRANSCRIPTION,
            self::ENDPOINTS_MODERATIONS,
            self::ENDPOINTS_VIDEO_GENERATION,
            self::ENDPOINTS_EMBEDDINGS,
    ...
    */
     ...
     * Sets model_id
     *
     * @param string $model_id Canonical model identifier.
     *
     * @return self
     */
     ...
     * Sets release_date
     *
     * @param \DateTime $release_date Earliest known public release date.
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param string $status Lifecycle status of the model (Rumoured, Announced, Available, Deprecated, Retired).
     *
     * @return self
     */
     ...
     * Sets aliases
     *
     * @param string[] $aliases Enabled aliases that resolve to this model.
     *
     * @return self
     */
     ...
     * Sets endpoints
     *
     * @param string[] $endpoints Gateway endpoints that currently route to this model.
     *
     * @return self
     */
    public function setEndpoints($endpoints)
    {
        ...
        $allowedValues = $this->getEndpointsAllowableValues();
        if (array_diff($endpoints, $allowedValues)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value for 'endpoints', must be one of '%s'",
     ...
     * Sets input_types
     *
     * @param string[] $input_types Input content types supported by the model itself.
     *
     * @return self
     */
     ...
     * Sets output_types
     *
     * @param string[] $output_types Output content types supported by the model itself.
     *
     * @return self
     */
