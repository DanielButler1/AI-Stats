...
/**
 * ModerationRequestInput Class Doc Comment
 *
 * @category Class
 * @description Input to classify. A single text string or an array of rich content items.
 * @package  AIStats\\Sdk
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class ModerationRequestInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ModerationRequestInput';
