...
class ImageGenerationRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ImageGenerationRequest';
    ...
    */
    ...
    public function setN($n)
    {
        ...
        if (($n > 10)) {
            throw new \InvalidArgumentException('invalid value for $n when calling ImageGenerationRequest., must be smaller than or equal to 10.');
        }
        if (($n < 1)) {
            throw new \InvalidArgumentException('invalid value for $n when calling ImageGenerationRequest., must be bigger than or equal to 1.');
        }
