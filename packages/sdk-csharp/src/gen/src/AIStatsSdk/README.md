...
inputSpec: apps/docs/openapi/v1/openapi.json
outputDir: out
...
namespace YourProject
{
    public class Program
    {
        public static async Task Main(string[] args)
        {
            ...
            GatewayHealthResponse? model = apiResponse.Ok();
        }
...
- appVersion: 0.1.0
- appDescription: Programmatic access to the AI Stats AI Gateway. All endpoints forward requests to the best available provider for the specified model, and return normalised responses with clear structured metadata.
