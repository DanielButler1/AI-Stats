...
namespace AIStatsSdk.Model
{
    ...
    public partial class ChatCompletionsRequest : IValidatableObject
    {
        ...
        /// <param name="maxCompletionsTokens">maxCompletionsTokens</param>
        /// <param name="meta">Include gateway metadata in the response. (default to false)</param>
        ...
        /// <param name="usage">Include token usage details in the response. (default to true)</param>
        [JsonConstructor]
        public ChatCompletionsRequest(string model, List<ChatMessage> messages, Option<ChatCompletionsRequestReasoning?> reasoning = default, Option<decimal?> frequencyPenalty = default, Option<Dictionary<string, decimal>?> logitBias = default, Option<int?> maxOutputTokens = default, Option<int?> maxCompletionsTokens = default, Option<bool?> meta = default, Option<decimal?> presencePenalty = default, Option<long?> seed = default, Option<bool?> stream = default, Option<decimal?> temperature = default, Option<List<Object>?> tools = default, Option<int?> maxToolCalls = default, Option<bool?> parallelToolCalls = default, Option<ChatCompletionsRequestToolChoice?> toolChoice = default, Option<bool?> logprobs = default, Option<int?> topLogprobs = default, Option<decimal?> topP = default, Option<bool?> usage = default)
        {
            Model = model;
            Messages = messages;
            ...
            MaxCompletionsTokensOption = maxCompletionsTokens;
            MetaOption = meta;
        ...
        /// <summary>
        /// Used to track the state of MaxCompletionsTokens
        /// </summary>
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<int?> MaxCompletionsTokensOption { get; private set; }

        /// <summary>
        /// Gets or Sets MaxCompletionsTokens
        /// </summary>
        [JsonPropertyName("max_completions_tokens")]
        public int? MaxCompletionsTokens { get { return this.MaxCompletionsTokensOption; } set { this.MaxCompletionsTokensOption = new(value); } }
        ...
        /// </summary>
        /// <value>Include gateway metadata in the response.</value>
        ...
        /// </summary>
        /// <value>Include token usage details in the response.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  MaxCompletionsTokens: ").Append(MaxCompletionsTokens).Append("\n");
        ...
        IEnumerable<ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            // MaxCompletionsTokens (int) minimum
            if (this.MaxCompletionsTokensOption.IsSet && this.MaxCompletionsTokensOption.Value < (int)1)
            {
                yield return new ValidationResult("Invalid value for MaxCompletionsTokens, must be a value greater than or equal to 1.", new [] { "MaxCompletionsTokens" });
            }
    ...
    public class ChatCompletionsRequestJsonConverter : JsonConverter<ChatCompletionsRequest>
    {
        ...
        public override ChatCompletionsRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<int?> maxCompletionsTokens = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "max_output_tokens":
                            ...
                            break;
                        case "max_completions_tokens":
                            maxCompletionsTokens = new Option<int?>(utf8JsonReader.TokenType == JsonTokenType.Null ? (int?)null : utf8JsonReader.GetInt32());
                            break;
                        case "meta":
            ...
            if (maxCompletionsTokens.IsSet && maxCompletionsTokens.Value == null)
                throw new ArgumentNullException(nameof(maxCompletionsTokens), "Property is not nullable for class ChatCompletionsRequest.");
            ...
            return new ChatCompletionsRequest(model.Value!, messages.Value!, reasoning, frequencyPenalty, logitBias, maxOutputTokens, maxCompletionsTokens, meta, presencePenalty, seed, stream, temperature, tools, maxToolCalls, parallelToolCalls, toolChoice, logprobs, topLogprobs, topP, usage);
        }
        ...
        public void WriteProperties(Utf8JsonWriter writer, ChatCompletionsRequest chatCompletionsRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (chatCompletionsRequest.MaxCompletionsTokensOption.IsSet)
                writer.WriteNumber("max_completions_tokens", chatCompletionsRequest.MaxCompletionsTokensOption.Value!.Value);
