...
namespace AIStatsSdk.Test.Api
{
    ...
    public sealed class ImagesApiTests : ApiTestsBase
    {
        ...
        /// <summary>
        /// Test ImagesGenerationsPost
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task ImagesGenerationsPostAsyncTest()
        {
            ImageGenerationRequest imageGenerationRequest = default!;
            var response = await _instance.ImagesGenerationsPostAsync(imageGenerationRequest);
            var model = response.Ok();
            Assert.IsType<ImageGenerationResponse>(model);
        }
    }
}
