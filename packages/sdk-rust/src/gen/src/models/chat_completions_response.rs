...
pub struct ChatCompletionsResponse {
    ...
    pub choices: Vec<models::GatewayChatChoice>,
}

impl ChatCompletionsResponse {
    pub fn new(provider: String, meta: models::GatewayMetadata, created: i32, model: String, choices: Vec<models::GatewayChatChoice>) -> ChatCompletionsResponse {
